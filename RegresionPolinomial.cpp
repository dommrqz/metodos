...
int main() {
	...
	//double x[] = { 273, 283, 293, 303, 313, 323, 333, 343, 353, 363, 373 };
	//double y[] = { 1.00738, 1.00129, 0.99883, 0.99802, 0.99804, 0.99854, 0.99943, 1.00067, 1.00229, 1.00437, 1.00697 };

	double x[] = { 0, 1, 2, 3, 4, 5 };
	double y[] = { 2.1, 7.7, 13.6, 27.2, 40.9, 61.1 };

	regresionPolinomial(x, y, sizeof(x)/sizeof(x[0]), 3);
